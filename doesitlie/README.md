# doesitlie — the citation-honesty record
...
Live board: **[doesitlie.org](https://doesitlie.org)** · every number on it opens its
exhibit: claim, source excerpt, the judge's evidence quote, a link to the original.

[![doesitlie](https://img.shields.io/endpoint?url=https%3A%2F%2Fdoesitlie.org%2Fbadge.json)](https://doesitlie.org)
...
```bash
node site/build_site.mjs   # data.json + doesitlie.csv + badge.json + og.html, injects the headline into index.html
```
...
- [`site/doesitlie.csv`](site/doesitlie.csv) — flat per-agent metrics
...
```bibtex
@misc{doesitlie2026,
  title  = {doesitlie: a citation-honesty audit of AI deep-research agents},
  author = {{doesitlie maintainers}},
  year   = {2026},
  url    = {https://doesitlie.org},
...
doesitlie is the narrower, complementary case: a **neutral** record — no vendor money, the
