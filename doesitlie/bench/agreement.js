// doesitlie Bench — judge-vs-human agreement. The credibility anchor: how often the
...
//
// Usage: node doesitlie/bench/agreement.js [gold/labels.json] [out/all/audit.json] [gold/labels_2.json]
...
async function main () {
  const goldPath = process.argv[2] || 'doesitlie/bench/gold/labels.json'
  const auditPath = process.argv[3] || 'doesitlie/bench/out/all/audit.json'
