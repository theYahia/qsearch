// doesitlie Bench — deterministic (claim, url) extractor.
...
//
// Usage: node doesitlie/bench/extract.js [out.json]   (builds from the manifest below)
...
async function main () {
  const R = 'doesitlie/bench/dataset/raw/'
  ...
  const dest = process.argv[2] || 'doesitlie/bench/dataset/all_submissions.json'
