# 🗺️ ROADMAP — Truthlode (+ qsearch substrate)

> Truthlode = открытый НЕЙТРАЛЬНЫЙ бенчмарк честности цитат AI deep-research агентов (legal v1) → verified-citation engine → RaaS, на суверенном qsearch-субстрате.
...
> Формат: фазы по порядку; [x] сделано, [ ] в работе. Источник секции :4444/#truthlode. Обновлено 2026-06-09.
...
- [ ] Static leaderboard site (truthlode.org → GH Pages): таблица + coverage% + клик→audit-trail (источник/excerpt)
...
### Truthlode Engine (Phase отложена)
