...
const audit = JSON.parse(fs.readFileSync('truthlode/bench/out/all/audit.json', 'utf-8'))
const labels = [
...
fs.mkdirSync('truthlode/bench/gold', { recursive: true })
fs.writeFileSync('truthlode/bench/gold/labels.json', JSON.stringify(out, null, 2))
