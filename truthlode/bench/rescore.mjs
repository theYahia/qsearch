...
//
// Usage: node truthlode/bench/rescore.mjs [out/all/audit.json] [out/all]
import fs from 'node:fs/promises'
import { scoreAgent, renderMarkdown, cmpRank } from './harness.js'

const auditPath = process.argv[2] || 'truthlode/bench/out/all/audit.json'
const outDir = process.argv[3] || 'truthlode/bench/out/all'
